...
void init_resource(VkDevice dev, VkMemoryPropertyFlags type, 
  uint32_t size, uint32_t* data, VkDeviceMemory* device_mem) {
...
void create_buffer(Context* ctx, VkBufferUsageFlags usage, 
  VkMemoryPropertyFlags type, uint32_t size, void* data, 
  VkDeviceMemory* device_mem, VkBuffer* buffer) {
