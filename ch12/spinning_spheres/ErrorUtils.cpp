...
VkBool32 messageCallbackFunc(VkDebugReportFlagsEXT flags,
...
void setupValidation(std::vector<const char*>& layerNames,
  ...
  auto layerRes = vk::enumerateInstanceLayerProperties();
  ck(layerRes.result);
  layerProps = layerRes.value;
