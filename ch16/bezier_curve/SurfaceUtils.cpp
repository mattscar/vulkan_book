...
void createXcbSurface(Context& ctx) {
  ...
  ctx.surface = ctx.instance.createXcbSurfaceKHR(surfaceInfo);
}
...
void getSurfaceFormats(Context& ctx) {
  ...
  std::vector<vk::SurfaceFormatKHR> formats = 
    ctx.physDevice.getSurfaceFormatsKHR(ctx.surface);
  ...
  std::vector<vk::PresentModeKHR> modes = 
    ctx.physDevice.getSurfacePresentModesKHR(ctx.surface);
